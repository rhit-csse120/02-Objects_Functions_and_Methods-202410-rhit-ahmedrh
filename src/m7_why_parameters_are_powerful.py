...
def main():
    ...
    # even_better_draw_circles(rg.Point(100, 50), 10,20,'red',5)
    # even_better_draw_circles(rg.Point(-200, 0), 30,5,'green', 10)
    even_better_draw_circles(rg.Point(0,0),10,60,'black',20)
    for f in range(5):
        for i in range(6):
            even_better_draw_circles(rg.Point(-300+150*f,400-120*i),5*i,5,'white',i)
    window.update()
